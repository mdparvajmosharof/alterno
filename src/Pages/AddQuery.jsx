...
const AddQuery = () => {
    ...
    const handleAddTouristsSpots = (e) => {
        ...
        const QueriesData = {
            Product_Name,
            Product_Brand, Product_Image_Url, Query_Title, Boycotting_Reason, photoURL, email, userName, Date_Posted
        }
    ...
    return (
        <div>
            ...
            <div className="w-1/2"><form onSubmit={handleAddTouristsSpots} action="">
